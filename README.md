...
Crusties is an AI-powered NFT collection of **500 unique pizza profile pictures (PFPs)** minted on the **Base** network. Each Crustie is generated by analyzing your Farcaster activity, cast history, engagement patterns, and on-chain personality — then baking it all into a pizza avatar that's uniquely *you*.
